...
disp(strcat("[Exp2: Heat Capacity Brass Solid Body] ", num2str(c_solid_body),"[J]/[g °C]"));
disp(strcat("[Exp2: Heat Capacity Brass Solid Body] ", num2str(c_solid_body * 1000),"[J]/[kg °C]"));
